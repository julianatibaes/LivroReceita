package com.example.julia.livroreceita;
...
import com.example.julia.livroreceita.adapter.ReceitaAdapter;
import com.example.julia.livroreceita.adapter.RecyclerViewOnClickListener;
import com.example.julia.livroreceita.model.Receita;

import java.util.ArrayList;
import java.util.List;

public class ListaReceitaActivity extends AppCompatActivity implements RecyclerViewOnClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_lista_receita, menu);
        return true;
    }
